...
@ObjectType({ description: "A track is a group of Modules that teaches about a specific topic" })
export class Track {
  @Field(() => ID)
  id: string;
  ...
  @Field(()=> String, { 
    nullable: true,
    description: "The track's illustration to display in track card or track page detail" })
  thumbnail?: string
